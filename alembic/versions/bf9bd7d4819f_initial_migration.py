...
Revision ID: bf9bd7d4819f
Revises: 8bf7d5ba72cc
Create Date: 2024-10-01 10:38:49.244741
...
revision: str = 'bf9bd7d4819f'
down_revision: Union[str, None] = '8bf7d5ba72cc'
...
def upgrade() -> None:
    ...
    op.add_column('subject', sa.Column('subject_val', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('subject', 'subject_val')
